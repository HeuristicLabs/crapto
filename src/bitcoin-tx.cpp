...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " crapto-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  crapto-tx [options] <hex-tx> [commands]  Update hex-encoded crapto transaction\n" +
            "or:     crapto-tx [options] -create [commands]   Create hex-encoded crapto transaction\n" +
            "\n";
