...
const char * const BITCOIN_CONF_FILENAME = "crapto.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Crapto";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Crapto";
#else
    // Unix
    return pathRet / ".crapto";
#endif
#endif
}
