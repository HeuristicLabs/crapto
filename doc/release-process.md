...
* Update manpages, see [gen-manpages.sh](https://github.com/crapto-project/crapto/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/crapto-project/gitian.sigs.ltc.git
    git clone https://github.com/crapto-project/crapto-detached-sigs.git
...
- Detached signatures will then be committed to the [crapto-detached-sigs](https://github.com/crapto-project/crapto-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the crapto.org server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the crapto.org server.

```
- Update crapto.org version
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/crapto-project/crapto/releases/new) with a link to the archived release notes.
