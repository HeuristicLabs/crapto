# Support for Output Descriptors in Crapto Core

Since Crapto Core v0.17, there is support for Output Descriptors. This is a
...
on Crapto's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Crapto Core wallets, a convenience function `combo` is
