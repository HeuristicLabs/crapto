...
"""Verify that starting crapto with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start crapto with -h for help text")
        ...
        self.log.info("Start crapto with -version for version information")
        ...
        self.log.info("Start craptod with -fakearg to make sure it does not start")
